...
from shop.views.get_filtered_products_view import GetFilteredProductsView
...
urlpatterns = [
    ...
    path('product/filter/', GetFilteredProductsView.as_view(), name="get_filtered_products"),
]
